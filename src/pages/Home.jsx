    ...
    <div className='container'>
      <div className='row align-items-center'>
        <div className='col-lg-6'>
            <h1 style={{ fontSize:'80px' }}><i className='fa-brands fs-docker'></i>projectfair</h1>
       <p style={{ fontSize:'30px' }}>Lorem Lorem Ipsum is simply dummy text of the printing Lorem Ipsum is simply dummy text of the printing </p>
       {
         ...
         <Card style={{ width: '18rem' }} className='me-3 mb-3'>
            <Card.Body>
                <Card.Title className='d-flex align-items-center justify-content-center mt-5 flex-column '>
                    <img width={'600px'} height={'600px'} className='rounded-circle img-fluid'src="https://cdn.imgbin.com/1/21/9/imgbin-business-digital-marketing-testimonial-business-avatar-zaQ0KGwkNuwHXe7LrW4mBSmri.jpg" alt=""/>
                ...
                <Card.Text>
                    ...
                    <p style={{ textAlign:'justify' }}>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                </Card.Text>
            </Card.Body>
        </Card>
